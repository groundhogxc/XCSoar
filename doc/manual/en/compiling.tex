...
If you are not sure, then you should probably start by downloading the current source first and then compiling the manual from that (see section \ref{sec:compiling-manuals}), or check the source code of the developer manual itself (\texttt{compiling.tex} and \texttt{developsetuplinux.tex}).
...
\subsection{Editing the Manuals}\ref{sec:compiling-manuals}
