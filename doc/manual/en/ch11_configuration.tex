...
The filter dialogue includes a \textbf{Clrnc} (clearance) column that
controls which airspace classes may be granted clearance by the pilot.
See Section~\ref{sec:airspace-clearances}.
